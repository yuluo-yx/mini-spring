...
import indi.yuluo.springframework.aop.framework.adapter.MethodBeforeAdviceInterceptor;
...
import indi.yuluo.springframework.test.bean.UserServiceBeforeAdvice;
...
public class ApiTest {
	...
	public void test_advisor() {
		...
		advisor.setExpression("execution(* indi.yuluo.springframework.test.bean.IUserService.*(..))");
